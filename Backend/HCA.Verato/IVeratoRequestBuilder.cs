...
/// <summary>
/// Verato request builder
/// </summary>
public interface IVeratoRequestBuilder
{
    /// <summary>
    /// Post identity request builder
    /// </summary>
    /// <param name="request">post identity request <see cref="PostClientIdentityRequest"/></param>
    /// <returns>return Post identity request for verato <see cref="PostIdentityRequest"></returns>
    ...
    /// <returns>return Link identities request for verato <see cref="LinkIdentitiesRequest"></returns>
    ...
    /// <returns>return Un link identities request for verato <see cref="UnLinkIdentitiesRequest"></returns>
    ...
    /// <returns>return Merge identities request for verato <see cref="MergeIdentitiesRequest"></returns>
    ...
    /// <returns>return Un merge identities request for verato <see cref="UnMergeIdentitiesRequest"></returns>
    ...
    NativeIdQueryRequest Build_NativeIdQueryRequest(NativeIdQueryClientIdentityRequest request);

    SearchNotificationsRequest Build_SearchNotificationsRequest(SearchClientIdentityNotificationsRequest request);
}
