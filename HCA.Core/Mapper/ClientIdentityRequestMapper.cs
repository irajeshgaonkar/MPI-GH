...
public class ClientIdentityRequestMapper : IMapper<ClientIdentityRequestEntity, ClientIdentityRequest>
{
    ...
    public IEnumerable<ClientIdentityRequestEntity> MapToEntityCollection(IEnumerable<ClientIdentityRequest> models)
    {
    ...
    public IEnumerable<ClientIdentityRequestEntity> MapToModelCollection(IEnumerable<ClientIdentityRequest> entities)
    {
